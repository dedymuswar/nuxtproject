<template>
  <header>
    <nav class="bg-teal-500 shadow-lg block lg:flex justify-between lg:px-10 mb-4">
      <div
        class="flex items-center text-white text-xl px-4 py-3 lg:p-0 border-b lg:border-none border-teal-400"
      >
        <!-- <svg class="w-6 h-6 fill-current mr-2" version="1.1" id="Air" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="lg:ml-4">
          <img class="h-10 object-cover" src="~/assets/images/logo3.png" alt srcset />
        </div>
      </div>
      <div class="block lg:flex items-center text-sm">
        <nuxt-link
          to="/" 
          class="text-teal-200 hover:text-white hover:bg-teal-600 block py-2 lg:py-5 px-5">Home</nuxt-link>
        <nuxt-link
          to="/posts"
          class="text-teal-200 hover:text-white hover:bg-teal-600 block py-2 lg:py-5 px-5"
        >Posts</nuxt-link>
        <nuxt-link
          to="/users"
          class="text-teal-200 hover:text-white hover:bg-teal-600 block py-2 lg:py-5 px-5"
